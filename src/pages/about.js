...
import profilerPic from "../../public/images/profile/jostin_profile.jpg";
...
const about = () => {
    return (
        ...
        '>
                            ...
                            <Image src={profilerPic} alt="JRCode" className='w-full h-auto rounded-2xl'
                                priority
